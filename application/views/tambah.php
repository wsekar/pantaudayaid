                                    ...
                                    <form action="<?= base_url('kategori/proses_tambah') ?>" id="form-tambah" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="kode_kategori" placeholder="Masukkan Kode kategori" autocomplete="off" class="form-control" required value="KG<?= mt_rand(100000, 999999) ?>" maxlength="8" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
